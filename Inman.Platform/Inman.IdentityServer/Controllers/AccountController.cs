...
using Inman.IdentityServer.Infrastructure;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginInputModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var loginResult = _userServiceClient.LoginValidate(new LoginStuff { UserName = model.Username, Password = model.Password });
                if (loginResult.Success)//_users.ValidateCredentials(model.Username, model.Password)
                {
