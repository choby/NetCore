...
(function (f, define) {
    ...
    (function ($, undefined) {
        ...
        var InmanFilterMenu = Widget.extend({
            ...
            _submit: function (e) {
                ...
                console.log(serializeFilter(this.filterModel.toJSON(),false));
        ...
        var InmanFilterMultiCheck = Widget.extend({
            init: function (element, options) {
        ...
        $.extend(InmanFilterMultiCheck.fn, {
            _click: InmanFilterMenu.fn._click,
            _keydown: InmanFilterMenu.fn._keydown,
            _reset: InmanFilterMenu.fn._reset,
            _closeForm: InmanFilterMenu.fn._closeForm,
            clear: InmanFilterMenu.fn.clear,
            _merge: InmanFilterMenu.fn._merge
        });
        ui.plugin(InmanFilterMenu);
        ui.plugin(InmanFilterMultiCheck);
    }(window.kendo.jQuery));
    return window.kendo;
