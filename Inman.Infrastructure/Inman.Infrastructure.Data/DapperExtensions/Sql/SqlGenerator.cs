...
namespace Inman.Infrastructure.Data.DapperExtensions.Sql
{
    public interface ISqlGenerator
    {
        ...
        string Select(IClassMapper classMap, string selectField, IPredicate predicate, IList<ISort> sort, IDictionary<string, object> parameters);
    ...
    public class SqlGeneratorImpl : ISqlGenerator
    {
        ...
        public virtual string Select(IClassMapper classMap,string selectField, IPredicate predicate, IList<ISort> sort, IDictionary<string, object> parameters)
        {
            if (parameters == null)
            {
                throw new ArgumentNullException("Parameters");
