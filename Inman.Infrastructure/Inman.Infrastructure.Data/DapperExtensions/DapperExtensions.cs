...
namespace Inman.Infrastructure.Data.DapperExtensions
{
    public static class DapperExtensions
    {
        ...
        /// Executes a select query using the specified predicate, returning an IEnumerable data typed as per T.
        /// </summary>
        public static IEnumerable<TField> GetFieldList<T, TField>(this IDbConnection connection,string selectField, object predicate = null, IList<ISort> sort = null, IDbTransaction transaction = null, int? commandTimeout = null, bool buffered = false) where T : class
        {
            return Instance.GetFieldList<T, TField>(connection, selectField, predicate, sort, transaction, commandTimeout, buffered);
        }
        /// <summary>
        /// Executes a select query using the specified predicate, returning an IEnumerable data typed as per T.
