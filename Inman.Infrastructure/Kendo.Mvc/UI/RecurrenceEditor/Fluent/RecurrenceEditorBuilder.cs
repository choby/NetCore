...
namespace Kendo.Mvc.UI.Fluent
{
    ...
    public class RecurrenceEditorBuilder : WidgetBuilderBase<RecurrenceEditor, RecurrenceEditorBuilder>
    {
        ...
        public RecurrenceEditorBuilder Messages(Action<SchedulerMessagesRecurrenceEditorSettingsBuilder<ISchedulerEvent>> addViewAction)
        {
            SchedulerMessagesRecurrenceEditorSettingsBuilder<ISchedulerEvent> builder = new SchedulerMessagesRecurrenceEditorSettingsBuilder<ISchedulerEvent>(Component.Messages);
