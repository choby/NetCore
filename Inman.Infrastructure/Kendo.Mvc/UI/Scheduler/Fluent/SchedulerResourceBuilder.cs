namespace Kendo.Mvc.UI.Fluent
{
    ...
    /// </summary>
    public class SchedulerResourceBuilder<T>
        where T : class, ISchedulerEvent
    {
        ...
        public SchedulerResourceBuilder(SchedulerResource<T> resource, ViewContext viewContext, IUrlGenerator urlGenerator)
        {
        ...
        /// </code>
        /// </example>
        public SchedulerResourceBuilder<T> DataSource(Action<ReadOnlyDataSourceBuilder> configurator)
        {
