...
namespace Kendo.Mvc.UI.Fluent
{
        ...
        where T : class 
    {
        ...
        public ChartSeriesExtremesBorderSettingsBuilder<T> Color(string value)
        {
        ...
        public ChartSeriesExtremesBorderSettingsBuilder<T> ColorHandler(string handler)
        {
        ...
        public ChartSeriesExtremesBorderSettingsBuilder<T> ColorHandler(Func<object, object> handler)
        {
            Container.Color = null;
        ...
        public ChartSeriesExtremesBorderSettingsBuilder<T> Width(double value)
        {
