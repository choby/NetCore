...
{
    /// <summary>
    /// Defines the fluent API for configuring EditorImageBrowserTransportDestroySettings
    /// </summary>
    public partial class EditorImageBrowserTransportDestroySettingsBuilder
        
    {
        ...
        public EditorImageBrowserTransportDestroySettingsBuilder Url(string value)
        {
        ...
        public EditorImageBrowserTransportDestroySettingsBuilder UrlHandler(string handler)
        {
            Container.Url = null;
        ...
        public EditorImageBrowserTransportDestroySettingsBuilder UrlHandler(Func<object, object> handler)
        {
            Container.Url = null;
