namespace Kendo.Mvc.UI
{
    ...
    public class PivotDataSourceSchema : JsonObject
    {
        ...
        protected override void Serialize(IDictionary<string, object> json)
        {
            ...
            {
                json.Add("axes", Axes, string.Empty);
            }
            ...
            {
                json.Add("cubes", Cubes, string.Empty);
            }
            ...
            {
                json.Add("catalogs", Catalogs, string.Empty);
            }
            ...
            {
                json.Add("measures", Measures, string.Empty);
            }
            ...
            {
                json.Add("dimensions", Dimensions, string.Empty);
            }
            ...
            {
                json.Add("hierarchies", Hierarchies, string.Empty);
            }
            ...
            {
                json.Add("levels", Levels, string.Empty);
            }
