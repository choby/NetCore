...
namespace Inman.Infrastructure.Common.Caching
{
    public class RedisCacheService : ICacheService
    {
        ...
        //    if(config == null)
        //        throw new Exception("\"RedisCacheManager\"类如果使用无参数的构造函数，需要在配置文件中配置名为\"redisConfig\"的节点，参数包含：Host(包含端口)、Password、 Ssl、 KeepAlive");
        //    if (connection == null || !connection.IsConnected)
        //    {
        //        connection = ConnectionMultiplexer.Connect(ConfigurationOptions.Parse(config.ToString()));
        //    }
        //}
