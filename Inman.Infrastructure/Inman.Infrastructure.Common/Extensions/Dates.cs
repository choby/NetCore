...
namespace Inman.Infrastructure.Common.Extensions
{
    ...
    public static class Dates
    {
        ...
        public static string S_DefaultDateTimeFormat = "yyyy-MM-dd HH:mm:ss";

        public static string S_DefaultDateFormat = "yyyy-MM-dd";
        ...
        public static DateTime MinOfDateTime(this DateTime dateTime)
        {
            return new DateTime(dateTime.Year, dateTime.Month, dateTime.Day, 0, 0, 0);
        }

        public static DateTime MaxOfDateTime(this DateTime dateTime)
        {
        ...
        /// UTC时间转本地时间
        /// </summary>
        /// <param name="s">UTC时间的字符串格式</param>
        /// <param name="format">UTC时间的格式</param>
        /// <returns></returns>
        public static DateTime ParseUTCToLocal(string s, string format = null)
        {
            return DateTime.ParseExact(s, format ?? S_DefaultDateTimeFormat, DateTimeFormatInfo.CurrentInfo, DateTimeStyles.AssumeUniversal);
        }

        public static DateTime ParseLocalToUTC(string s, string format = null)
        {
            return DateTime.ParseExact(s, format ?? S_DefaultDateTimeFormat, DateTimeFormatInfo.CurrentInfo, DateTimeStyles.None).ToUniversalTime();
        }
        ...
        /// <returns></returns>
        public static string ConvertToUTCString(this DateTime value, string format = null)
        {
            format = format ?? S_DefaultDateTimeFormat;
        ...
        /// <param name="format"></param>
        /// <returns></returns>
        public static string ConvertToLocalString(this DateTime value, string format = null)
        {
            format = format ?? S_DefaultDateTimeFormat;
        ...
        /// <param name="format"></param>
        /// <returns></returns>
        public static string FormatToDate(this DateTime? dateTime, string format = null)
        {
            if (dateTime == null)
            { return string.Empty; }

            format = format ?? S_DefaultDateFormat;
        ...
        public static string FormatToDate(this DateTime dateTime, string format = null)
        {
            return ((DateTime?)dateTime).FormatToDate(format);
        }
        ...
        /// <param name="format"></param>
        /// <returns></returns>
        public static string FormatToDateTime(this DateTime? dateTime, string format = null)
        {
            if (dateTime == null)
            { return string.Empty; }
        ...
        public static string FormatToDateTime(this DateTime dateTime, string format = null)
        {
            return ((DateTime?)dateTime).FormatToDateTime(format);
        }
    }
}