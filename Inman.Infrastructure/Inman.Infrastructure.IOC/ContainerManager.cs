...
namespace Inman.Infrastructure.IOC
{
    public class ContainerManager
    {
        ...
        public object ResolveUnregistered(Type type)
        {
            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (service == null) throw new ComponentRegistrationException("Unkown dependency");
            ...
            throw new ComponentRegistrationException("No contructor was found that had all the dependencies satisfied.");
        }
